...
class LeNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(52380, 1000)  # self.fc1 = nn.Linear(16280, 1000) change feature
...
def resnet50(pretrained=False, **kwargs):
    ...
    model.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3, bias=False).cuda()
    model.avgpool = nn.AvgPool2d((2, 5), stride=(2, 5)).cuda()
    model.fc = nn.Linear(512 * 4, 11).cuda()
    return model
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.fc = nn.Linear(512 * 4, 11)#512*8 for logmeldelta 512*4 for logmel
    return model
