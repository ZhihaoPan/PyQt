...
def run():
    ...
    # loading data
    if demotest:
        demo_dataset=demo.wavLoader(test_path,demo_path, window_size=window_size, window_stride=window_stride, window_type=window_type,
    ...
    print('\nStart training...')
    if demotest:
        demo_test(demo_loader,model, cuda, mode='Test loss', class2index=demo_dataset.getClass2Index())
    else:
